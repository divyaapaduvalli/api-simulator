...
public class WiremockStubMappingReader {
  ...
  /**
   * Retrieves all the api mocks that are found under the
   * resources/{application}/{environment}/mocks
   *
  ...
  /**
   * This is almost similar to the stub mapping reader but in this case WireMockServer searches for
   * a directory named __files and there should stay all the static files response that the Wiremock
   * server should read.
   *
   * @param wiremockServerKey - used to identify the correct classpath
